...
const Features = () => {
    ...
    },
  {
    ...
    description: "تمامی محصولات در مجموعه مستر روبات از برندهای معتبر و به‌صورت کاملاً اورجینال ارائه می‌شوند.",
    icon: <GoVerified className='size-12 lg:size-14'/>
    },
  {
    name: 'تعویض قطعه قدیمی با نو',
    description:"با تایید متخصصان ما‍‌ قطعه قدیمی‌تان را به ما تحویل دهید و با پرداخت مابه‌التفاوت، قطعه جدید مورد علاقه‌تان را دریافت کنید.",
